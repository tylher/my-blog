...
third_user = User.create(name: 'Test', photo: 'https://unsplash.com/photos/F_-0BxGuVvo', bio: 'Doctor from Brazil',posts_counter: 0)
fourth_user = User.create(name: 'Test2', photo: 'https://unsplash.com/photos/F_-0BxGuVvo', bio: 'Doctor from Brazil',posts_counter: 0)
